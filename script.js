...
// ***** animateCase TimeLine - End *****

// ***** animateEarPod TimeLine - Start *****
animateEarPod
  .to(".ear-pod-wrapper", 2, {
    translateY: -190
  }, 0);
// ***** animateEarPod TimeLine - End *****

// ***** animatePlugCharger TimelineMax - Start *****
animatePlugCharger
  .to(".charger-wire", 0.1, {
  ...
  .set(".case-wrapper", { rotateZ: 0 });
// ***** animatePlugCharger TimelineMax - End *****
